...
tags = {
  ...
  layout = { layouts[1], layouts[6], layouts[2]
}}
for s = 1, screen.count() do
...
local strf = '<span font="' .. font .. '" color="#EEEEEE" background="#777E76">%b %d %H:%M %G</span>'
...
vicious.register(netwidget, vicious.widgets.net, function(widget, args)
    ...
    return '<span background="#C2C2A4" font="Inconsolata 11"> <span font ="Inconsolata 11" color="#737373">'..args["{"..interface.." down_kb}"]..'kbps'..'</span></span>' end, 10)
...
vicious.register( batwidget, vicious.widgets.bat, '<span background="#92B0A0" font="Inconsolata 11"><span font="Inconsolata 11" color="#CC3333" background="#92B0A0">$1$2% </span></span>', 30, "BAT1" )
...
awful.rules.rules = {
    ...
    -- Set Xterm as floating with a fixed position
 	{ rule = { class = "XTerm" }, 
 	  properties = {floating = true}, callback = function(c) c:geometry({x=0, y=16}) end},
    { rule = { class = "MPlayer" },
    ...
    { rule = { class = "Chromium" },
      properties = { tag = tags[1][2], switchtotag = true } },
    -- Set Gedit to tags number 3 of screen 1 and switch to the tag.
    { rule = { class = "Gedit" },
