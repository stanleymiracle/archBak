...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ " eins " }, s, awful.layout.layouts[1])
    awful.tag({ " zwei " }, s, awful.layout.layouts[2])
    awful.tag({ " drei " }, s, awful.layout.layouts[3])
...
globalkeys = awful.util.table.join(
    ...
    -- {{ Opens texmacs }} --
    awful.key({ modkey,           }, "t", function() awful.util.spawn("transmission-qt") end),
...
awful.rules.rules = {
    ...
    { rule_any = { class = { "Google-chrome-unstable", "Firefox" } },
      properties = { tag = " zwei ", switchtotag = true }
    },

    { rule_any = { class = { "Atom" } },
      properties = { tag = " drei ", switchtotag = true }
    },

    { rule_any = { class = { "XTerm", "mpv", "Thunar", "transmission", "Emacs"} },
